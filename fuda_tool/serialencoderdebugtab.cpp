...
QWidget *SerialEncoderDebugTab::createDataGroup()
{
    ...
    layout->addWidget(m_readAbsoluteButton, 0, 6);
    layout->addWidget(m_readMultiTurnButton, 0, 7);
    ...
    layout->addWidget(m_statusEdit, 2, 3);
    layout->addWidget(new QLabel(QStringLiteral("ALMC"), group), 2, 4);
    layout->addWidget(m_almcEdit, 2, 5);
    layout->addWidget(new QLabel(QStringLiteral("单圈编码值"), group), 2, 6);
    layout->addWidget(m_rawEdit, 2, 7);
    layout->addWidget(new QLabel(QStringLiteral("绝对角度"), group), 3, 0);
    layout->addWidget(m_angleEdit, 3, 1);
    layout->addWidget(new QLabel(QStringLiteral("多圈圈数"), group), 3, 2);
    layout->addWidget(m_turnsEdit, 3, 3);
    layout->addWidget(new QLabel(QStringLiteral("总编码值"), group), 3, 4);
    layout->addWidget(m_totalEdit, 3, 5);
    layout->addWidget(new QLabel(QStringLiteral("解析摘要"), group), 3, 6);
    layout->addWidget(m_dataSummaryEdit, 3, 7);
