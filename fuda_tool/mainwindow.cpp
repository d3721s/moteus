...
QWidget *MainWindow::createAnticoggingPanel()
{
    ...
    layout->addWidget(m_anticoggingSplitSpin, 3, 3, Qt::AlignLeft);
    ...
    layout->addWidget(m_anticoggingPolesSpin, 4, 3, Qt::AlignLeft);
    ...
    layout->addWidget(m_anticoggingProcess.outputEdit, 6, 0, 1, 5);
